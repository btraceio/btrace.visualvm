...
import org.openjdk.btrace.tooling.spi.BTraceSettingsProvider;
import org.openjdk.btrace.visualvm.api.options.BTraceSettings;
...
public class BTraceSettingsProviderImpl implements BTraceSettingsProvider {
    public BTraceSettings getSettings() {
        return BTraceSettings.sharedInstance();
    }
}
