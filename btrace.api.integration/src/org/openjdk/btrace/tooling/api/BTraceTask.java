...
public abstract class BTraceTask {
    ...
    public static abstract class MessageDispatcher implements EventListener {
        ...
        public void onDisconnect(String probeId) {};
        public void onReconnect(String probeId) {}
        public void onListProbes(List<String> probes) {}
    }
    ...
    /**
     * Returns the name specified in {@linkplain org.openjdk.btrace.core.annotations.BTrace} annotation
     * @return Returns the name specified in {@linkplain org.openjdk.btrace.core.annotations.BTrace} annotation or NULL if not specified
     */
