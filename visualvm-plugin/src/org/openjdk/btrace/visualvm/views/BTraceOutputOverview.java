...
public class BTraceOutputOverview extends DataSourceViewPlugin {
    ...
    public DataViewComponent.DetailsView createView(int i) {
        ...
        try {
            ...
            return new DataViewComponent.DetailsView("BTrace Output", "BTrace Output", 99, new OutputPane(r), null);
        } catch (IOException e) {
            return new DataViewComponent.DetailsView("BTrace Output", "BTrace Output", 99, new JLabel(e.getLocalizedMessage()), null);
        }
    }
}
