 ...
 */
class JavaFXSGNodeProbe extends JavaFXProbe {

    private static final String NAME = "Scenegraph nodes statistic";
    private static final String DESCR = "Scenegraph nodes statistic";
    ...
    private static final ProbeItemDescriptor[] createItemDescriptors() {
        return new ProbeItemDescriptor[] {
            ProbeItemDescriptor.lineItem("Node count", "Amount of nodes in sceengraph", ItemValueFormatter.DEFAULT_DECIMAL, 0, ProbeItemDescriptor.MAX_VALUE_UNDEFINED),
            ProbeItemDescriptor.lineItem("Layout required", "How many nodes layout required", ItemValueFormatter.DEFAULT_DECIMAL, 0, ProbeItemDescriptor.MAX_VALUE_UNDEFINED)
        };
    }

    private static final String[] createAttrs() {
        return new String[] { "nodeCount", "needsLayout" }; // NOI18N
    }
