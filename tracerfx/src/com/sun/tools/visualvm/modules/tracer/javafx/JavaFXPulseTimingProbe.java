 ...
 */
class JavaFXPulseTimingProbe extends JavaFXProbe {

    private static final String NAME = "Scenegraph mouse and key event timing";
    private static final String DESCR = "Monitors mouse and keyboard event timing";
    private static final int POSITION = 50;


    JavaFXPulseTimingProbe() {
    ...
    private static final ProbeItemDescriptor[] createItemDescriptors() {
        return new ProbeItemDescriptor[] {
            ProbeItemDescriptor.lineItem("Mouse events time", "Monitors keyboard processing time", ItemValueFormatter.DEFAULT_DECIMAL, 0, ProbeItemDescriptor.MAX_VALUE_UNDEFINED),
            ProbeItemDescriptor.lineItem("Key events time", "Monitors keyboard processing time", ItemValueFormatter.DEFAULT_DECIMAL, 0, ProbeItemDescriptor.MAX_VALUE_UNDEFINED)
        };
    }

    private static final String[] createAttrs() {
        return new String[] { "mousePulsesCumulativeTime", "keyPulsesCumulativeTime" }; // NOI18N
    }
}
