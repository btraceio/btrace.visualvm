 ...
 */
class JavaFXPulseCountProbe extends JavaFXProbe {

    private static final String NAME = "Scenegraph mouse and key statistic";
    private static final String DESCR = "Monitors mouse and keyboard activity";
    private static final int POSITION = 40;


    JavaFXPulseCountProbe() {
    ...
    private static final ProbeItemDescriptor[] createItemDescriptors() {
        return new ProbeItemDescriptor[] {
            ProbeItemDescriptor.lineItem("Mouse events", "Monitors mouse activity", ItemValueFormatter.DEFAULT_DECIMAL, 0, ProbeItemDescriptor.MAX_VALUE_UNDEFINED),
            ProbeItemDescriptor.lineItem("Key events", "Monitors keyboard activity", ItemValueFormatter.DEFAULT_DECIMAL, 0, ProbeItemDescriptor.MAX_VALUE_UNDEFINED)
        };
    }

    private static final String[] createAttrs() {
        return new String[] { "mousePulses", "keyPulses" }; // NOI18N
    }
